...
function lodgifywp_enqueue_scripts() {
    // Enqueue styles
    wp_enqueue_style('lodgifywp-style', get_stylesheet_uri(), array(), '1.0.5');
    wp_enqueue_style('lodgifywp-main', get_template_directory_uri() . '/assets/css/main.css', array(), '1.0.5');
    
    // Enqueue scripts
    wp_enqueue_script('lodgifywp-main', get_template_directory_uri() . '/assets/js/main.js', array('jquery'), '1.0.5', true);
